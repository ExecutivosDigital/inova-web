                    ...
                    {message.role === "user" ? (
                      <div className="flex justify-end gap-2 text-end">
                        <div className="flex flex-col items-end">
                          <div className="bg-secondary flex min-h-[40px] flex-col rounded-xl p-2">
                      ...
                      <div className="flex justify-start gap-2 text-start">
                        ...
                        <div className="flex flex-col">
                          <div className="bg-secondary/80 flex flex-col rounded-xl p-2">
                            {message.content === "..." ? (
