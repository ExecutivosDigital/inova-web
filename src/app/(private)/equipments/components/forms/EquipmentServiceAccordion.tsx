...
export function EquipmentServiceAccordion({
    ...
    setEquipmentData((prevEquipment) =>
      prevEquipment.map((equipment, eqIndex) => {
        ...
        if (!updatedServices[serviceIndex]) {
          const defaultService: ServiceTypeProps = {
            id: selectedService?.id || "",
            name: selectedService?.name || "",
            position: selectedService?.position || "",
            description: selectedService?.description || "",
            period: value, // Set the period using the new value
            executionTime: "",
            priority: "",
            team: "",
            serviceCondition: "",
          ...
          updatedServices[serviceIndex] = defaultService;
        } else {
  ...
  const isEquipmentServiceFullyFilled = (data: ServiceTypeProps) => {
    return (
      ...
      data.lubricantNeeded !== "" &&
      data.jobSystem !== "" &&
      data.lubricantAmount !== "" &&
        ...
        <div className="flex w-full items-center justify-between">
          <div className="text-primary flex items-center gap-2 text-base font-bold md:gap-4 md:text-2xl">
            ...
            <div className="flex flex-col">
              <span className="w-max leading-6">Serviços</span>
              <span
                className={cn(
                  "w-max text-xs font-normal text-neutral-500 md:text-sm",
                  selectedEquipmentStep !== 5 && "hidden",
                )}
              >
              ...
              <div className="col-span-2 grid grid-cols-2 gap-2 md:gap-4">
                <div className="flex flex-col">
                  ...
                  <input
                    ...
                    placeholder="Período / Frequência"
                    value={
                ...
                <div className="flex flex-col">
                  ...
                  <input
                    type="text"
                    className="h-10 w-full rounded-2xl bg-white p-2 px-2 shadow-[0px_0px_10px_0px_rgba(0,0,0,0.15)] placeholder:text-neutral-300 focus:outline-none md:h-12 md:px-4"
                    placeholder="Condição de Serviço"
                    value={
                      equipmentData.find((eq) => eq.id === selectedEquipment.id)
                        ?.services[
                        Number(selectedService.position.split("S")[1]) - 1
                ...
                <div className="flex flex-col">
                  ...
                  <input
                    type="text"
                    className="h-10 w-full rounded-2xl bg-white p-2 px-2 shadow-[0px_0px_10px_0px_rgba(0,0,0,0.15)] placeholder:text-neutral-300 focus:outline-none md:h-12 md:px-4"
                    placeholder="Sistema de Trabalho"
                    value={
                      equipmentData.find((eq) => eq.id === selectedEquipment.id)
                        ?.services[
                        Number(selectedService.position.split("S")[1]) - 1
                ...
                <div className="flex flex-col">
                  ...
                  <input
                    type="text"
                    className="h-10 w-full rounded-2xl bg-white p-2 px-2 shadow-[0px_0px_10px_0px_rgba(0,0,0,0.15)] placeholder:text-neutral-300 focus:outline-none md:h-12 md:px-4"
                    placeholder="Quantidade de Lubrificante"
                    value={
                      equipmentData.find((eq) => eq.id === selectedEquipment.id)
                        ?.services[
                        Number(selectedService.position.split("S")[1]) - 1
