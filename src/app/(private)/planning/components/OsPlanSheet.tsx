...
interface OsPlanSheetProps {
  open: boolean;
  onClose: () => void;
  selectedOs: PlanningProps;
}

export function OsPlanSheet({ open, onClose, selectedOs }: OsPlanSheetProps) {
      ...
      <Sheet open={open}>
        ...
        >
          <SheetHeader className="px-6">
            <SheetTitle>Editar Planejamento de OS</SheetTitle>
          </SheetHeader>
