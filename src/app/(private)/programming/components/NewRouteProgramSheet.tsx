...
interface NewRouteProgramSheetProps {
  name: string;
  description?: string;
  attendees: string[];
}
...
const NewRouteProgramSheet = ({
  ...
  const [newEventData, setNewEventData] = useState<NewRouteProgramSheetProps>({
    name: "",
    description: "",
    attendees: [],
  });
...
export default NewRouteProgramSheet;
