...
export const inputVariants = cva(
  " w-full border-zinc-400 bg-background px-3 h-9 file:border-0 file:bg-transparent  file:font-medium  read-only:leading-9 read-only:bg-background  disabled:cursor-not-allowed disabled:opacity-50  transition duration-300 ",
  {
    variants: {
      color: {
        default:
          "text-default-900 focus:outline-none focus:border-default-900 disabled:bg-default-200  placeholder:text-accent-foreground/50",
        primary:
